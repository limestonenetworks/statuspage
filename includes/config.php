...
$config['textarea'] = array(
	'heading' => 'Get Support',
	'text' => 'Having service issues? In the event that our ticketing system, OnePortal, is offline we will monitor emails sent to <a href="mailto:support@limestonenetworks.com">support@limestonenetworks.com</a>. Please be advised that unless OnePortal is inaccessable this mail box is not actively monitored and you should <a href="https://one.limestonenetworks.com/support/newticket.html" target="_blank">open a ticket</a> for support.'
);
?>
